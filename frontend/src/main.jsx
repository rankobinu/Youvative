    ...
    <Provider store={store}>
      <Router>
        <Routes>
          ...
          <Route
            path="/admin/user/:userId/newuserstrategy"
            element={<NewUserStrategy />}
          />
          <Route
            path="/admin/user/:userId/activeuserstrategy"
            element={<ActiveUserStrategy />}
          />
          <Route
            path="/admin/user/:userId/inactiveuserstrategy"
            element={<InactiveUserStrategy />}
          />
          <Route
            path="/admin/user/:userId/resubscribeduserstrategy"
            element={<ResubscribedUserStrategy />}
          />
          <Route path="/admin/user/activeusers" element={<ActiveUsers />} />
          <Route
            path="/admin/user/resubscribedusers"
            element={<ResubscribedUsers />}
          />
