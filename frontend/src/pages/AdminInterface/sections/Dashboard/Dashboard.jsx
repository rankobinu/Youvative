...
function Dashboard() {
  ...
  const inactiveVsOthersData = [
    ...
    {
      name: "Other Users",
      value: stats.activeUsers + stats.newUsers + stats.resubscribedUsers,
      color: "rgba(33, 191, 228, 0.7)",
    },
  ];
  ...
  const resubscribedVsInactiveData = [
    {
      name: "Resubscribed Users",
      value: stats.resubscribedUsers,
      color: "rgba(94, 21, 235, 0.7)",
    },
    {
      name: "Inactive Users",
      value: stats.inactiveUsers,
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-400">
              <span className="text-[#21BFE4] font-medium">
                {stats.totalUsers}
              </span>{" "}
              total users
            </div>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`bg-gradient-to-r ${card.color} p-3 rounded-full`}
                    >
                  ...
                  <p className={`${card.textColor} text-sm mt-2`}>
                    {Math.round((card.value / stats.totalUsers) * 100)}% of
                    total users
                  </p>
                </div>
                <div
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                  ...
                  <div className="flex items-end gap-2">
                    <p className="text-white text-2xl font-bold">
                      {Math.round(
                        ((stats.totalUsers - stats.inactiveUsers) /
                          stats.totalUsers) *
                          100,
                      )}
                      %
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                  ...
                  <div className="flex items-end gap-2">
                    <p className="text-white text-2xl font-bold">
                      {isNaN(
                        Math.round(
                          (stats.resubscribedUsers /
                            (stats.inactiveUsers + stats.resubscribedUsers)) *
                            100,
                        ),
                      )
                        ? 0
                ...
                <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <p className="text-red-400/80 text-sm mb-1">to recover</p>
                  </div>
                </div>
              </div>
            </div>
