  ...
  return (
    <div className="bg-gradient-to-t from-[#5E4683] to-[#150F1D] w-full h-screen overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="bg-white/10 backdrop-blur-md px-10 py-6 rounded-lg max-w-lg w-full shadow-lg border border-white/10">
        ...
        <h1 className="text-4xl text-[#5E15EB] font-extrabold mb-6 text-center">Reset Your Password</h1>
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 text-center">
              <RouterLink to="/login" className="text-[#9B9B9B] hover:text-white transition-colors duration-300">
                Back to Login
              </RouterLink>
            </div>
          </form>
          ...
          <div className="text-center text-white">
            <div className="bg-green-500/20 p-4 rounded-md mb-6">
              <p className="mb-4">If an account exists with the email <span className="font-semibold">{email}</span>, we've sent instructions to reset your password.</p>
