          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400">
                {userData.occupation || "Content Creator"}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/5 p-4 rounded">
              ...
              <p className="text-white">
                {userData.subscription?.plan || "Basic Plan"}
              </p>
            </div>
            <div className="bg-white/5 p-4 rounded">
            ...
            <div className="bg-white/5 p-4 rounded">
              ...
              <p className="text-white">
                {userData.subscription?.end_date || "Not available"}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg">
          <div className="flex items-center gap-4 mb-4 text-white">
            {strategyIcons[strategy]?.platformIcon || (
              <FaInstagram className="text-2xl" />
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white/5 p-4 rounded">
              ...
              <div className="flex items-center mt-2">
                <span
                  className={`px-2 py-[0.25em] text-sm font-semibold rounded-full bg-white ${userStatus[userData.status || "active"]}`}
                >
