...
function PerformanceAnalytics() {
    ...
    const fetchAnalyticsData = async () => {
      try {
        ...
        setMonthlyGoal({
          ...
          description: monthlyStrategyData.description || 'No description available.'
        });
        ...
        const counts = {
          ...
          upcoming: tasksData.filter(task => task.status === 'upcoming').length,
  ...
  if (loading) {
    return <div className="text-white text-center py-10">Loading analytics data...</div>;
  }
