    ...
    <div className="flex flex-col h-full overflow-hidden relative">
      <div className="text-center self-end z-10 mr-15 mt-15 mb-8 text-[#B28FFA] font-extrabold">
        ...
        <RouterLink to="/signup">
            <button className="bg-[#B28FFA] self-center text-2xl text-black rounded-sm py-3 px-20 font-extrabold mt-2  transition-transform hover:scale-105 duration-300 cursor-pointer">SignUp</button>
        </RouterLink>
      </div>
      <img
